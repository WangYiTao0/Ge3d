...
#define GE_PROFILE_SCOPE(name) constexpr auto fixedName = ::GE::InstrumentorUtils::CleanupOutputString(name, "__cdecl ");\
									::GE::InstrumentationTimer timer##__LINE__(fixedName.Data)
